...
{
define("URL","https://{$_SERVER['SERVER_NAME']}/projects/pharmahealth/");
define("PATH","{$_SERVER['DOCUMENT_ROOT']}/projects/pharmahealth/");
}
...
define("ADMIN_FORM_EMAIL","ashrafzaman121@gmail.com");
