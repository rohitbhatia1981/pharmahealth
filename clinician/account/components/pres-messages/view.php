					...
					<div class="e-panel card">
						<div class="card-body">
									...
									<table class="table table-bordered border-top text-nowrap" id="example1" width="100%">
										<thead>
											<tr>
                                                ...
                                                <th width="58%" class="border-bottom-0">Subject</th>
                                                <th width="16%" class="border-bottom-0">Sent by</th>                                                
                                                <th width="13%" class="border-bottom-0">Last replied</th>
							...
							?>				
								...
								<tr style="font-weight:<?php echo $readStatus; ?>; cursor:pointer" class="trrow"  onclick="window.location='<?php echo URL.PRESCRIBER_ADMIN?>?c=pres-prescriptions&task=detail&id=<?php echo $row['pres_id']?>&tab=message'">
                                    ...
                                    <td class="align-middle">
												...
												<?php echo getUserNameByType(strtolower($row['message_sender_type']),$row['message_sender_id']); ?> &nbsp;  
                                                
                                                <?php if ($row['message_sender_type']=="Pharmacy") { ?>
                                                <span class="tag tag-orange"> <?php echo $row['message_sender_type']; ?></span>
                                                <?php }else if ($row['message_sender_type']=="Patient") { ?>
                                                <span class="tag tag-blue"> <?php echo $row['message_sender_type']; ?></span>
                                                <?php }
												 else { ?>
