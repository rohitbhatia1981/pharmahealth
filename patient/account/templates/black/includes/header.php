<?php 
if ($_SESSION['sess_patient_name']!="")
{
	$fullName = $_SESSION['sess_patient_name'];
										...
										<div class="dropdown profile-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="p-3 text-center border-bottom">
													<a href="#" class="text-center user pb-0 font-weight-bold"><?php echo $_SESSION['name'] ?></a>
													<p class="text-center user-semi-title">Patient Account</p>
												</div>
												
												<a class="dropdown-item d-flex" href="index.php?c=edit-profile">
												...
												<a class="dropdown-item d-flex" href="<?php echo URL?><?php echo PATIENT_ADMIN?>logout.php">
