					...
					<div class="e-panel card">
						<div class="card-body">
                           ...
                           <div style="height:20px"></div>
							...
							?>			
								<tr  style="font-weight:<?php echo $readStatus; ?>; cursor:pointer" class="trrow"  onclick="window.location='<?php echo URL.PATIENT_ADMIN?>?c=<?php echo $component?>&task=detail&id=<?php echo $row['message_id']?>'">
										...
										<div class="d-flex">
											<div class="ml-3 mt-1">
												...
												?>
															...
															<span class="tag tag-grey">Response Pending</span>
                                                            <?php } else { ?>
                                                            <span class="tag tag-red">Read Admin Reply</span>
                                                            <?php } ?>
															...
															for ($i=0;$i<count($resMessage);$i++)
															{
																...
																//-----------end update read---------
																			 ...
																			 if ($rowMessage['message_sender_type']=="Pharmacy")
																				...
																				else if ($rowMessage['message_sender_type']=="Patient")
																				{
																					$replierName="You";
																					$colorCss="success";
																				}
