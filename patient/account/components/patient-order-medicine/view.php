		...
		<div class="col-12">
			<div class="row">
							<div class="col-xl-6 col-md-12 col-lg-12">
								<div class="card">
                                    ...
                                    <div class="order-img"><img src="<?php echo URL?>images/order-med.jpg" alt="" ></div>
										<p>To order medication for a new condition you will need to first select your condition from the drop down list below, and then complete our medical assessment form to be offered appropriate treatment options for you to select. Our instructions will guide you through.</p>
                                      <form method="GET" action="<?php echo URL?>treatments/tdetail">
										...
										<p align="center"><button type="submit" class="btn btn-pink">Start Now</button></p>
							...
							<div class="col-xl-6 col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header border-0">
										<h3 class="card-title" style="color:#3366ff; font-size:25px; text-align:center!important; padding-top:12px">Re-order </h3>
										
									</div>
									<div class="card-body pt-2">
                                    <div class="order-img"><img src="<?php echo URL?>images/re-order.jpg" alt="" ></div>
										<div>Review and re-order medications you have ordered previously.<br />
									  </div>
										<div>
										<br />
										<p>&nbsp;</p>
                                        <p align="center"><a href="?c=patient-prescriptions" class="btn btn-primary">Re-Order</a></p>
								  </div>
								</div>
							</div>
