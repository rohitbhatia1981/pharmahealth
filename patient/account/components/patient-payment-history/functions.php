<?php
	...
	global $database, $page, $pagingObject;
		...
		$sql = "SELECT payment_id, payment_date, payment_amount,payment_pres_id,payment_status from tbl_payments WHERE payment_patient_id='".$database->filter($_SESSION['sess_patient_id'])."'  ";
