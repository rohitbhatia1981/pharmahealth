<?php
	...
	global $database, $page, $pagingObject;
		 ...
		 $sql = "SELECT * FROM tbl_messages,tbl_prescriptions WHERE pres_id=message_pres_id and pres_patient_id='".$_SESSION['sess_patient_id']."' and message_sent_to='Patient'";
		...
		if($_GET['imp'] == "1")
		{
			$sql .=" and message_patient_important=1";
		}
