			...
			<div class="col-sm-6">
				...
				<div class="left text-center">
					...
					<div class="form-group">
						<input type="password" class="form-control" name="txtLoginPwd" id="txtLoginPwd" placeholder="Enter New Password" data-validation="required" data-validation-error-msg="Enter password" autocomplete="off">
					</div>
                    
                    <div class="form-group">
						<input type="password" class="form-control" name="txtLoginPwd2" id="txtLoginPwd2" placeholder="Re-enter New Password" data-validation-confirm="txtLoginPwd" data-validation="confirmation" data-validation-error-msg="Password did not matched" autocomplete="off">
					</div>
                ...
                onSuccess : function($form) {
				  ...
				  // $("#error-container-login").html("Please wait..</div>");
				    ...
				    var fd = new FormData(myform );	
		  			   ...
		  			   $.ajax({
					   type: "POST",
					   url: "<?php echo URL?>patient/ajax/submit-reset-password.php",
					   data: fd,
					   cache: false,
       				   processData: false,
        			   contentType: false,
					  ...
					  // alert (msg);
						   if (msg==1)
						   {
						   	window.location='<?php echo URL?>patient/login?reset=1';	
