...
<?php } ?>							
	...
	<div class="row flex-lg-nowrap">
		...
		<input type="checkbox" class="custom-control-input" name="chkControl" value="yes" onClick="checkAll(this.form,this.checked);" />
												...
												<th width="185"   class="border-bottom-0 w-60">Holiday Title</th>
                                                <th width="179" class="border-bottom-0 w-60">Date</th>
				...
				<input name="deletes[]" id="chkDelete" onClick="isChecked(this.checked);" class="custom-control-input" value="<?php echo $row['holiday_id']; ?>" type="checkbox" />			
											<span class="custom-control-label"></span>
										</label>
									</td>
									<td class="align-middle">
										<div class="d-flex">
											<div class="ml-3 mt-1">
												...
												<a href="?c=<?php echo $component?>&task=edit&Cid=<?php echo $menuid['component_headingid']; ?>&id=<?php echo $row['holiday_id']; ?>"><?php echo $row['holiday_title']; ?></a>
											</div>
										</div>
									</td>
                                    <td><?php echo displayDateFormat($row['holiday_date']); ?></td>
                                    
									<td class="align-middle">
										<div class="btn-group align-top">
											<button class="btn btn-sm btn-white"  ><a href="?c=<?php echo $component?>&task=edit&Cid=<?php echo $menuid['component_headingid']; ?>&id=<?php echo $row['holiday_id']; ?>">Edit</a></button>
									...
									<td class="align-middle">
										...
										<?php }else if($row['holiday_status'] == 0){ ?>
...
<div class="page-header d-lg-flex d-block">
	<div class="page-leftheader">
	<h4 class="page-title">Bank Holiday: 
...
<div class="col-md-6">
   ...
   <div class="card-body pb-2">
							...
							<div class="form-group">
								...
								<input class="form-control mb-4" type="text" id="txtHoliday" name="txtHoliday" value="<?php echo $row['holiday_title']?>" required>
							</div>
                            
                            <div class="form-group">
								<label class="form-label">Date</label>
								<input class="form-control mb-4" type="date" id="txtHolidayDate" name="txtHolidayDate" value="<?php echo $row['holiday_date']?>">
							</div>
						...
						<div class="custom-controls-stacked">
							<label class="custom-control custom-radio">
								<input type="radio" class="custom-control-input" name="rdoPublished" id="rdoPublished" value="1" <?php if($row['holiday_status']=="1" || $row['holiday_status']=='') echo 'checked="checked"'; ?>>
								<span class="custom-control-label">Yes</span>
							</label>
							<label class="custom-control custom-radio">
								<input type="radio" class="custom-control-input" name="rdoPublished" id="rdoPublished" value="0" <?php if($row['holiday_status']==0 && $row['holiday_status']!='') echo 'checked="checked"'; ?>>
