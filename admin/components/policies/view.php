...
<?php } ?>							
	...
	<div class="row flex-lg-nowrap">
		...
		<input type="checkbox" class="custom-control-input" name="chkControl" value="yes" onClick="checkAll(this.form,this.checked);" />
												...
												<th width="52%" class="border-bottom-0 w-20">Policy Title</th>	
                                                <th width="21%" class="border-bottom-0 w-20">Policy File</th> 
                                                <th width="21%" class="border-bottom-0 w-20">Policy For</th>                                                 
				...
				<input name="deletes[]" id="chkDelete" onClick="isChecked(this.checked);" class="custom-control-input" value="<?php echo $row['file_id']; ?>" type="checkbox"  />			
									...
									<td class="align-middle" style="width:50%">
                                     ...
                                     <td>
                                    	...
                                    	<a href="<?php echo URL?>uploads/files/<?php echo $row['file_name']?>" target="_blank">View File</a>
                                        <?php } ?>
                                     </td>
...
<div class="page-header d-lg-flex d-block">
	<div class="page-leftheader">
	<h4 class="page-title">Policy : <?php if (@count($row)>0) echo 'Edit'; else echo 'Add'; ?></h4>
	</div>
	<div class="page-rightheader ml-md-auto">
		<div class=" btn-list">
