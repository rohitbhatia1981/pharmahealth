<?php
	...
	global $database, $page, $pagingObject;
		...
		//$sql = "SELECT * FROM tbl_faq_medicine where 1 order by page_title asc";


		$sql = "SELECT * FROM tbl_faq_medicine where 1";
	...
	global $database, $component;
		...
		$add_query = $database->insert( 'tbl_faq_medicine', $names );
	...
	function createFormForPages($id)

			{
				...
				$sql = "SELECT * FROM tbl_faq_medicine where faq_id='".$database->filter($id)."'";
...
//Add the WHERE clauses
		...
		$updated = $database->update( 'tbl_faq_medicine', $update, $where_clause, 1 );
...

	{
...

		{
			...
			$delete = $database->delete( 'tbl_faq_medicine', $where_clause, 1 );
...

	{
		...
		global $database,$component;	
			...
			$del = $database->delete( 'tbl_faq_medicine', $where_clause, 1 );
			print "<script>window.location='index.php?c=".$component."&Cid=9'</script>";
