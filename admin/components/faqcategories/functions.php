<?php
	...
	global $database, $page, $pagingObject;
		...
		//$sql = "SELECT * FROM tbl_faq_categories where 1 order by faq_categories_name asc";

		$sql = "SELECT * FROM tbl_faq_categories where 1";
		...
		$sql .= " order by faq_categories_name asc";
	...
	global $database, $component;
		...
		$add_query = $database->insert( 'tbl_faq_categories', $names );
	...
	function createFormForPages($id)

			{
				...
				$sql = "SELECT * FROM tbl_faq_categories where faq_categories_id ='".$database->filter($id)."'";
...
//Add the WHERE clauses
		...
		$updated = $database->update( 'tbl_faq_categories', $update, $where_clause, 1 );
...

	{
...

		{
			...
			$delete = $database->delete( 'tbl_faq_categories', $where_clause, 1 );
...

	{
		...
		global $database,$component;	
			...
			$del = $database->delete( 'tbl_faq_categories', $where_clause, 1 );
			print "<script>window.location='index.php?c=".$component."&Cid=9'</script>";
