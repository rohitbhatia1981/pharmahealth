...
//Add the WHERE clauses
...

	{
		...
		//----------sending cancellation request to clinician and saving log---
		
		if ($_POST['cmbPharmacyStage']==4)
		{		
		...
		//----------end sending cancellation request to clinician and saving log---	
