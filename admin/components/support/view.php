					...
					<div class="e-panel card">
						<div class="card-body">
                           ...
                           <div style="height:20px"></div>
							...
							if ($row['message_read_status_admin']==0)
							$readStatus="bold";
							else
							$readStatus="normal";
							...
							?>			
								<tr style="font-weight:<?php echo $readStatus; ?>; cursor:pointer" class="trrow"  onclick="window.location='?c=<?php echo $component?>&task=detail&id=<?php echo $row['message_id']?>'">
										...
										<div class="d-flex">
											<div class="ml-3 mt-1">
												...
												?>
															...
															<span class="tag tag-red">Response Required</span>
                                                            <?php } else { ?>
                                                            <span class="tag tag-green">Reply Sent</span>
                                                            <?php } ?>
                                                 ...
                                                 <?php 
														...
														if (count($resMessage)>0)
														{
															...
															for ($i=0;$i<count($resMessage);$i++)
															{
																...
																changeReadStatus2_admin($rowMessage['message_id']);
																			 ...
																			 if ($rowMessage['message_sender_type']!="Admin")
																				{
																					...
																					$replierName=getUserNameByType(strtolower($rowMessage['message_sender_type']),$rowMessage['message_sender_id'])." (".$rowMessage['message_sender_type'].")";
