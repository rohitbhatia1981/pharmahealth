...
<?php } ?>							
	...
	<div class="row flex-lg-nowrap">
		...
		<input type="checkbox" class="custom-control-input" name="chkControl" value="yes" onClick="checkAll(this.form,this.checked);" />
                                                ...
                                                <th width="268" class="border-bottom-0 w-60">Logo</th>
				...
				<input name="deletes[]" id="chkDelete" onClick="isChecked(this.checked);" class="custom-control-input" value="<?php echo $row['pp_id']; ?>" type="checkbox" />			
											<span class="custom-control-label"></span>
										</label>
									</td>
									<td class="align-middle">
										<div class="d-flex">
											<div class="ml-3 mt-1">
												...
												<a href="?c=<?php echo $component?>&task=edit&Cid=<?php echo $menuid['component_headingid']; ?>&id=<?php echo $row['pp_id']; ?>"><?php echo $row['pp_name']; ?></a>
											</div>
										</div>
									</td>
                                    <td><img src="<?php echo URL; ?>classes/timthumb.php?src=<?php echo URL ?>images/partner/<?php echo $row['pp_image']; ?>&w=150&h=70&zc=1">
                                    </td>
									<td class="align-middle">
...

{
	...
	<tr >
		...
		<th colspan="5" class="border-bottom w-10" style="text-align:center;"> - No Record found - </th>
	</tr>
...
<div class="page-header d-lg-flex d-block">
	<div class="page-leftheader">
	<h4 class="page-title">Partner Pharmacy : <?php if (@count($row)>0) echo 'Edit'; else echo 'Add'; ?></h4>
	</div>
	<div class="page-rightheader ml-md-auto">
		<div class=" btn-list">
...
<div class="row">
   ...
   <div class="card-body pb-2">
							...
							<div class="form-group">
								...
								<input class="form-control mb-4" type="text" id="txtClient" name="txtClient" value="<?php echo $row['pp_name']?>" required>
							</div>
					   ...
					   <!-- Image Upload -->
						...
						<div class="custom-controls-stacked">
							<label class="custom-control custom-radio">
								<input type="radio" class="custom-control-input" name="rdoPublished" id="rdoPublished" value="1" <?php if($row['pp_status']=="1" || $row['pp_status']=='') echo 'checked="checked"'; ?>>
								<span class="custom-control-label">Yes</span>
							</label>
							<label class="custom-control custom-radio">
								<input type="radio" class="custom-control-input" name="rdoPublished" id="rdoPublished" value="0" <?php if($row['pp_status']==0 && $row['pp_status']!='') echo 'checked="checked"'; ?>>
...
<input type="hidden" name="id" value="<?php echo $row['pp_id']?>" />	
...
$(document).ready(function(){
	$('#images4ex').orakuploader({
		...
		orakuploader_main_path : '../images/partner',
		orakuploader_thumbnail_path : '../images/partner',
