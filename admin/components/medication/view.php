     ...
     <?php
										...
										foreach ($results as $value)
										 {
											...
											?>
										<option value="<?php echo $value['condition_id']; ?>" <?php if ($_GET['task']=="edit") { if (@in_array($value['condition_id'],$strCategory)) echo 'selected'; } else if ($_GET['task']=="add") { if ($value['condition_id']==$_GET['cat']) echo 'selected'; } ?>><?php echo $value['condition_title']; ?></option>
										 <?php
                                        }
                                        ?>
					   ...
					   <!-- Image Upload -->
                            ...
                            <div class="form-group">
								...
								<textarea   name="txtHighlights" rows="6" cols="150" ><?php echo $row['med_highlights']?></textarea>
							</div>
...
<input type="hidden" name="hdCatId" value="<?php echo $_GET['cat']?>" />
	</form>					
								</div>
