...
<?php } ?>							
	...
	<div class="row flex-lg-nowrap">
							...
							<div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 col-xl-2">
												<div class="form-group">
													...
													<input class="form-control fc-datepicker" name="txtEDate" placeholder="" type="date" value="<?php echo $_GET['txtEDate']?>">
												</div>
											</div>
		...
		<input type="checkbox" class="custom-control-input" name="chkControl" value="yes" onClick="checkAll(this.form,this.checked);" />
                                                ...
                                                <th width="17%" class="border-bottom-0"> Date Sent</th>
				...
				<input name="deletes[]" id="chkDelete" onClick="isChecked(this.checked);" class="custom-control-input" value="<?php echo $row['message_id']; ?>" type="checkbox"  />			
									...
									<div class="card-body pb-0 pt-3">
										<div>
											...
											<p class="" style="font-weight:<?php echo $readStatus?>">Order ID: <a href="?c=<?php echo $_GET['c']?>&txtSearchByTitle=PH-<?php echo $row['message_pres_id']?>" style="color:#09C">PH-<?php echo $row['message_pres_id']; ?></a>, <?php echo getConditionName($row['pres_condition']); ?>, Date: <?php echo displayDateFormat($row['message_date']); ?></p>
										</div>
									</div>	
                                    ...
                                    <td class="align-middle">
												...
												<?php echo fnDateOrTime($row['message_date']); ?>
