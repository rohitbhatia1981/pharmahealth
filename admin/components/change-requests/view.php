						...
						<div class="card-body">
                           					...
                           					<div class="col-md-12 col-lg-12 col-xl-3">
														<div class="form-group">
															...
															<div class="input-group">
																...
																</div><input class="form-control fc-datepicker" name="txtSearch" placeholder="Search by Request id or Patient Name" value="<?php echo $_GET['txtSearch']?>" type="text">
															</div>
														</div>
													</div>
									...
									<table class="table table-bordered border-top text-nowrap" id="example1" width="100%">
										<thead>
											<tr>
												...
												<th width="7%" class="border-bottom-0">Request ID</th>
                                                <th width="17%" class="border-bottom-0">Patient ID </th>
                                                <th width="13%" class="border-bottom-0">Existing Pharmacy </th>
                                                <th width="14%" class="border-bottom-0">New Pharmacy Requested </th>
                                                <th width="18%" class="border-bottom-0">Message</th>
                                                <th width="8%" class="border-bottom-0">Patient Name</th>                                                
                                                <th width="13%" class="border-bottom-0">Sent Date</th>
							...
							?>				
								...
								<tr   >
                                    ...
                                    <td><a href="?c=patients&task=detail&id=<?php echo $row['pr_patient_id']?>"><?php echo $row['pr_patient_id']?></a></td>
									
                                    <td class="align-middle" >
                                    
                                   	<?php echo $row['pr_old_pharmacy']?>
											
									</td>
                                    <td><?php echo getPharmacyName($row['pr_new_pharmacy']); ?></td>
                                    <td><?php echo $row['pr_reason']?></td>
                                    
                                    
                                    
                                    <td class="align-middle">
										
										<?php echo getUserNameByType('patient',$row['pr_patient_id'])?>
                                    ...
                                    <td class="align-middle">
												...
												<?php echo displayDateTimeFormat($row['pr_date']); ?>
