                         ...
                         <?php if ($_GET['ty']=="") { ?>    
									...
									<table class="table table-bordered border-top text-nowrap" id="example1" width="100%">
										<thead>
											<tr>
                                              ...
                                              <th width="19%" class="border-bottom-0">Payment Amount </th>
							...
							?>
								<tr>
                                   ...
                                   <?php $paymentStatus=$rowPres['payment_status']; 
								   if ($paymentStatus==1)
								   {
								   ?>
                                    <a href="<?php echo URL?>pdf/create-invoice-pdf.php?aid=<?php echo encryptId($rowPres['payment_id']);?>" style="color:#06F; text-decoration:underline">#<?php echo $rowPres['payment_id']?></a>
                                ...
                                <?php } ?>	
                                    ...
                                    <td>
                                    		<?php 
															...
															$address.=", <br>".$rowPres['patient_city'];
