<?php
	...
	global $database, $page, $pagingObject;
		...
		$sql = "SELECT payment_id, payment_date, payment_amount,payment_pres_id,payment_status,patient_first_name,patient_middle_name,patient_last_name,patient_address1,patient_address2,patient_city,patient_postcode from tbl_payments, tbl_prescriptions,tbl_patients where pres_id=payment_pres_id and pres_patient_id=patient_id";

		if($_GET['txtSearchByTitle'] != "")

		{

			$sql .= " and (payment_pres_id like '%".$database->filter(str_replace("PH-","",$_GET['txtSearchByTitle']))."%' || payment_id like '%".$database->filter($_GET['txtSearchByTitle'])."%')";
