...
<?php } ?>							
	...
	<div class="row flex-lg-nowrap">
		...
		<input type="checkbox" class="custom-control-input" name="chkControl" value="yes" onClick="checkAll(this.form,this.checked);" />
				...
				<input name="deletes[]" id="chkDelete" onClick="isChecked(this.checked);" class="custom-control-input" value="<?php echo $row['faq_categories_id']; ?>" type="checkbox"  />			
											<span class="custom-control-label"></span>
										</label>
									</td>
									<td class="align-middle">
										<div class="d-flex">
											<div class="ml-3 mt-1">
												<a href="?c=<?php echo $component?>&task=edit&Cid=<?php echo $menuid['component_headingid']; ?>&id=<?php echo $row['faq_categories_id']; ?>"><?php echo $row['faq_categories_name']; ?></a>
											</div>
										</div>
									</td>
									<td class="align-middle">
										<div class="btn-group align-top">
											<button class="btn btn-sm btn-white"  ><a href="?c=<?php echo $component?>&task=edit&Cid=<?php echo $menuid['component_headingid']; ?>&id=<?php echo $row['faq_categories_id']; ?>">Edit</a></button>
									...
									<td class="align-middle">
										<div class="btn-group align-top">
										<?php if($row['faq_categories_status'] == 1){ ?>

										<span class="tag tag-green">Enabled</span>

										<?php }else if($row['faq_categories_status'] == 0){ ?>
...
<div class="page-header d-lg-flex d-block">
	<div class="page-leftheader">
	<h4 class="page-title">Faq Pharmacy Category : <?php if (@count($row)>0) echo 'Edit'; else echo 'Add'; ?></h4>
	</div>
	<div class="page-rightheader ml-md-auto">
		<div class=" btn-list">
...
<div class="row">
   ...
   <div class="card-body pb-2">
					...
					<div class="form-group">
								...
								<input class="form-control mb-4" type="text" name="faqcat_title" id="faqcat_title" value="<?php echo $row['faq_categories_name']?>" required>
							</div>
						...
						<div class="custom-controls-stacked">
							<label class="custom-control custom-radio">
								<input type="radio" class="custom-control-input" name="rdoPublished" id="rdoPublished" value="1" <?php if($row['faq_categories_status']=="1" || $row['faq_categories_status']=='') echo 'checked="checked"'; ?>>
								<span class="custom-control-label">Yes</span>
							</label>
							<label class="custom-control custom-radio">
								<input type="radio" class="custom-control-input" name="rdoPublished" id="rdoPublished" value="0" <?php if($row['faq_categories_status']==0 && $row['faq_categories_status']!='') echo 'checked="checked"'; ?>>
...
<input type="hidden" name="faqCat_id" value="<?php echo $row['faq_categories_id']?>" />	
