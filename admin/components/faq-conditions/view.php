	...
	<div class="row flex-lg-nowrap">
							...
							<div class="row">
											...
											<div class="col-md-12 col-lg-12 col-xl-3">
												<div class="form-group">
                                                    ...
                                                    <?php
														$sqlCategory="select * from tbl_conditions where condition_status=1 order by condition_title";
		...
		<input type="checkbox" class="custom-control-input" name="chkControl" value="yes" onClick="checkAll(this.form,this.checked);" />
				...
				<input name="deletes[]" id="chkDelete" onClick="isChecked(this.checked);" class="custom-control-input" value="<?php echo $row['faq_id']; ?>" type="checkbox"  />			
                                    ...
                                    <td class="align-middle">
										<?php echo getConditionName($row['faq_category']); ?>
...
<div class="page-header d-lg-flex d-block">
	<div class="page-leftheader">
	<h4 class="page-title">FAQs for condition : <?php if (@count($row)>0) echo 'Edit'; else echo 'Add'; ?></h4>
	</div>
	<div class="page-rightheader ml-md-auto">
		<div class=" btn-list">
...
<div class="row">
   ...
   <div class="card-body pb-2">
							...
							<div class="form-group">
								<label class="form-label">Faq Conditions</label>
								
									<select class="form-control" name="faq_conditions" id="faq_conditions"  >
										<option label="Select Conditions"></option>
										<?php
				...
				$results = $database->get_results( $query );
						...
						foreach ($results as $value) {
								...
								<option value="<?php echo $value['condition_id']; ?>"  <?php if ($_GET['task']=="edit") { if($row['faq_category'] == $value['condition_id']) {	echo 'selected="selected"';} } else { if ($value['condition_id']==$_SESSION['sessFAQCondition']) {	echo 'selected="selected"';}    }?>  ><?php echo $value['condition_title']; ?></option>
