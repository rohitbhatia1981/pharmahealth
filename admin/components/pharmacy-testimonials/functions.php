<?php
	...
	global $database, $page, $pagingObject;
		...
		$sql = "SELECT * FROM tbl_testimonials_pharmacy where 1";
	...
	global $database, $component;
		...
		$add_query = $database->insert( 'tbl_testimonials_pharmacy', $names );
	...
	function createFormForPages($id)

			{
				...
				$sql = "SELECT * FROM tbl_testimonials_pharmacy where testimonial_id='".$database->filter($id)."'";
...
//Add the WHERE clauses
		...
		$where_clause = array(
		 ...
		 $updated = $database->update( 'tbl_testimonials_pharmacy', $update, $where_clause, 1 ); 
		 $lastInsertedId=$database->lastid();
...

	{
...

		{
			...
			$delete = $database->delete( 'tbl_testimonials_pharmacy', $where_clause, 1 );
