			...
			<div class="page-single">
				<div class="container">
							...
							<div class="row justify-content-center">
								<div class="col-md-7 col-lg-5">
									<div class="card" style="top:15%;">
                                        ...
                                        <?php if ($_GET['otp']=="sent" && $_SESSION['sess_admin_id_temp']!="") { ?>
                                        ...
                                        <?php } else {
											...
											<div class="submit">
                                                ...
                                                <br>
                                                <a href="<?php echo URL?>admin/">Go back to login page</a>
                   ...
                   <p>We've sent an instruction to your email id. Please follow it to reset your password.</p>
                    ...
                    <div id="error-container-login" style="color:#F00; padding:10px"></div>
                   <p>Your password has been updated, you can now login with the new password. <a href="<?php echo URL?>admin/" style="color:#069; text-decoration:underline">Click here to login</a></p>
