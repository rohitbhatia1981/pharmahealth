...
<section class="banner_1 d-inline-flex align-items-center" style="background-image: url(images/banner-2.jpg);">
	<div class="container">
		<h3 class="title_h3">FAQs for Pharmacies</h3>
	</div>
</section>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-4">
                ...
                <?php 
					$sqlCategory="select * from tbl_faq_categories_pharmacy where faq_categories_status=1 order by faq_categories_id";
			...
			<div class="col-sm-8">
             ...
             <div class="tab-content" id="v-pills-tabContent">
              ...
              <?php 
					$sqlFCategory="select * from tbl_faq_categories_pharmacy where faq_categories_status=1 order by faq_categories_id";
              ...
              <?php
			  		$sqlFaqs="select * from tbl_faq_pharmacy where faq_category='".$database->filter($rowFCategory['faq_categories_id'])."' and faq_status=1";
