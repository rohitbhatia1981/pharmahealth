 ...
 exit;
	...
	if($totalMember>0)
		...
		$rowMemberid = $result[0]; 
			        ...
			        $_SESSION['sess_pharmacy_name'] = $rowMemberid['patient_first_name']." ".$rowMemberid['patient_last_name'];
			        $_SESSION['sess_pharmacy_email'] = $rowMemberid['patient_email'];			       
			        $_SESSION['sess_pharmacy_groupid'] = 4;
