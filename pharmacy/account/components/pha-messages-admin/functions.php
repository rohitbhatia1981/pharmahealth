<?php
	...
	global $database, $page, $pagingObject;
		  ...
		  $sql = "SELECT * FROM tbl_tickets WHERE message_sender_id='".$_SESSION['sess_pharmacy_id']."' and message_sender_type='Pharmacy' and message_parent=0";
	...
	$fileCount = count($_FILES['flDoc']['name']);
		...
		if ($hid>0)
		{
		$updateStatus="update tbl_tickets set message_replier_status=0 where message_id='".$database->filter($hid)."'";
