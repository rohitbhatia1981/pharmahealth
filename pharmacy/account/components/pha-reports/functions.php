<?php
	...
	function showPayout()
	{
		...
		showPayoutHTML($results);
	}
	
	function showPresReport()
	{
		$results=array();
		
		showPresReportHTML($results);
	}
	
	function showUncollectedReport()
	{
		$results=array();
		
		showUncollectedReportHTML($results);
	}
	...
	function showPerformanceReport()
	{
		...
		showPerformanceReportHTML($results);
	}
