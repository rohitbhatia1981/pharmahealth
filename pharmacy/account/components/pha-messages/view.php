				...
				<div class="col-12 mb-3">
					<div class="e-panel card">
						<div class="card-body">
							...
							?>			
								<tr style="font-weight:<?php echo $readStatus; ?>; cursor:pointer" class="trrow"  onclick="window.location='<?php echo URL.PHARMACY_ADMIN?>?c=pha-prescriptions&task=detail&id=<?php echo $row['pres_id']?>&tab=message'">
                                    ...
                                    <td class="align-middle">
                                                ...
                                                <?php if ($row['message_sender_type']=="Clinician") { ?>
                                                <span class="tag tag-orange"> <?php echo $row['message_sender_type']; ?></span>
                                                <?php } else if ($row['message_sender_type']=="Admin") { ?>
