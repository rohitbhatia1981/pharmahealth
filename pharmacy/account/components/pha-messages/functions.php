<?php
	...
	global $database, $page, $pagingObject;
		  ...
		  $sql = "SELECT * FROM tbl_messages,tbl_prescriptions,tbl_patients WHERE patient_id=pres_patient_id and pres_id=message_pres_id and patient_pharmacy='".$_SESSION['sess_pharmacy_id']."' and message_sent_to='Pharmacy'";
