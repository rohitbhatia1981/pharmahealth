...
<html lang="en" dir="ltr"><head>
		...
		<!--Sidemenu css -->
        <link  href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/css/sidemenu.css" rel="stylesheet">

		<!--Texteditor css -->
		<link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/wysiwyag/richtext.css" rel="stylesheet">
		...
		<!---Sidebar css-->
		<link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/sidebar/sidebar.css" rel="stylesheet" />
		...
		<link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/jvectormap/jqvmap.css" rel="stylesheet" />

		<!-- INTERNAL Data table css -->
		<link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/datatable/css/dataTables.bootstrap4.min.css" rel="stylesheet" />

		<!-- INTERNAL Time picker css -->
		<link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/time-picker/jquery.timepicker.css" rel="stylesheet" />

		<link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.min.css" rel="stylesheet" />
        
        <link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/date-picker/date-picker.css" rel="stylesheet" />
        
        <link rel="stylesheet" href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.css">
        
       
        

		<!-- INTERNAL jQuery-countdowntimer css -->
		<link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/jQuery-countdowntimer/jQuery.countdownTimer.css" rel="stylesheet" />
		<link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/accordion/accordion.css" rel="stylesheet" />
		
		
        <!-- INTERNAL WYSIWYG Editor css -->
		<link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/wysiwyag/richtext.css" rel="stylesheet" />
        
		<link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/quill/quill.snow.css" rel="stylesheet">
		<link href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/quill/quill.bubble.css" rel="stylesheet">
		...
		<script src="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/jquery.tokeninput.js"></script>
		<link rel="stylesheet" type="text/css" href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/token-input.css">
		
		<!-- Orakuploader CSS-->
		<link type="text/css" href="<?php echo URL?><?php echo PHARMACY_ADMIN?>orakuploader/orakuploader.css" rel="stylesheet"/>
	
		<!-- Jquery js-->
		
		<script src="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/jquery/jquery.validate.js"></script>

		<link rel="stylesheet" href="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/multipleselect/multiple-select.css">

		<script src="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/multipleselect/multiple-select.js"></script>
		<script src="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/multipleselect/multi-select.js"></script>


		<!-- Orakuploader js-->
		<script type="text/javascript" src="<?php echo URL?><?php echo PHARMACY_ADMIN?>orakuploader/jquery-ui.min.js"></script>
		<script type="text/javascript" src="<?php echo URL?><?php echo PHARMACY_ADMIN?>orakuploader/orakuploader.js"></script>
        
        <script src="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/modal-datepicker/datepicker.js"></script>
   
    <script src="<?php echo URL?><?php echo PHARMACY_ADMIN?>templates/black/assets/plugins/date-picker/date-picker.js"></script>
...
<body class="app sidebar-mini">
		...
		<div class="page">
         ...
         <?php require_once(PATH.PHARMACY_ADMIN."templates/black/includes/sidebar.php"); ?>
		 <div class="app-content main-content">
			<div class="side-app">
				<?php require_once(PATH.PHARMACY_ADMIN."templates/black/includes/header.php"); ?>
				...
				$filename = PATH.PHARMACY_ADMIN."components/".$component."/controller.php";
				
				
				if (file_exists($filename))
				require_once($filename);
				else
				require_once(PATH.PHARMACY_ADMIN."components/error/view.php");
				 ?>
        
			</div>
        </div>
                
              <?php require_once(PATH.PHARMACY_ADMIN."templates/black/includes/footer.php"); ?>  
...
$(document).on("click", "#qrcode", function () {
			 ...
			 $('#qrcode-popup').modal('show');
			 $('#qrfull-detail').load('qrcode/generate.php?id='+aid, function (response, status, xhr) {
                if (status == "success") {
                   //$('#qrcode-popup').modal('show')
                }
