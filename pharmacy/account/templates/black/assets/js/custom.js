...

{
	...
	if (pressbutton=="save" || pressbutton=="saveedit")

	{

			

		checkVal=checkValidation();
...

{
...

	{
		...
		if (wotForm.elements[a].id.indexOf("chkDelete") == 0) 
...

	{
		...
		document.adminForm.hidCheckedBoxes.value++;
